export default function AuthLayout({
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center bg-gradient-to-br from-[#0f1e35] via-[#1c3557] to-[#0e2a44] overflow-hidden pt-20 pb-12 px-4">
