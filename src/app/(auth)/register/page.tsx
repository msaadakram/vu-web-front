  ...
  return (
    ...
    >
      <div className="text-center mb-8">
        ...
        <p className="text-[#64788f] text-sm mt-2">Join VirtualU to upload and access resources</p>
      </div>

      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        <div className="space-y-1.5">
          <label className="text-sm font-medium text-[#0f1e35]">Full Name</label>
          <div className="relative">
            <User className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#64788f]" />
            <Input
              type="text"
      ...
      <p className="text-center text-sm text-[#64788f] mt-6">
        ...
        <Link href="/login" className="text-[#4eafc4] font-semibold hover:underline">
          Log in
        </Link>
      </p>
    </motion.div>
